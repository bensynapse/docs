...
If you want to see a detailed usage example, see [Couchbase Vector Store](https://docs.couchbase.com/server/current/vector-search/vector-search.html).
...
The CouchbaseSemanticCache needs a Search Index defined to work. Please look at the [usage example](https://docs.couchbase.com/server/current/vector-search/vector-search.html) on how to set up the index.
