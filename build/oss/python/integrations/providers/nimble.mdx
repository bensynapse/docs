...
<Columns cols={2}>
  <Card title="NimbleSearchTool" href="https://docs.nimbleway.com/nimble-sdk/search-api" cta="Get started" icon="magnifying-glass" arrow>
  ...
  <Card title="NimbleExtractTool" href="https://docs.nimbleway.com/nimble-sdk/extract-api" cta="Get started" icon="file-lines" arrow>
...
<Columns cols={2}>
  <Card title="NimbleSearchRetriever" href="https://docs.nimbleway.com/nimble-sdk/search-api" cta="Get started" icon="magnifying-glass" arrow>
    Search retriever with fast/deep modes. Navigate dynamic sites and extract full page content for RAG applications.
  </Card>
  <Card title="NimbleExtractRetriever" href="https://docs.nimbleway.com/nimble-sdk/extract-api" cta="Get started" icon="file-lines" arrow>
