...
For more on Netmind chat models, visit the [`langchain-netmind` repository](https://github.com/protagolabs/langchain-netmind)

## Embedding model

For more on Netmind embedding models, visit the [package](https://github.com/protagolabs/langchain-netmind)
