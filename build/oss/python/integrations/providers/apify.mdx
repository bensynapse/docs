...
See [this notebook](https://docs.apify.com/platform/integrations/langchain) for example usage and a full example of a tool-calling agent with LangGraph in the [Apify LangGraph agent Actor template](https://apify.com/templates/python-langgraph).
...
For a more detailed walkthrough of this loader, see the [Apify dataset docs](https://docs.apify.com/platform/storage/dataset).
