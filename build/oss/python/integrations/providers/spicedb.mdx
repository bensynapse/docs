...
For a detailed walkthrough, see the [SpiceDB Retriever](https://github.com/authzed/langchain-spicedb) package.
...
For a detailed walkthrough, see the [SpiceDB Tools](https://github.com/authzed/langchain-spicedb) page.
